    ...
    <div>
      ...
      <div className="container">
        <Routes>
          ...
          <Route path="/addStockType" element={<CreateStockTypeComponent />}></Route>
          <Route path="/viewStock/:stock_ID" element={<ViewStockComponent />}></Route>
          <Route path="/update-Stock/:stock_ID" element={<UpdateStockComponent />}></Route>
          <Route path="/menu" element={<ListMenuComponent />}></Route>
          {/* <Route path="/DashboardUser/:totalOrder_ID/:table_ID/:compoSite" element={<DashboardUser />}></Route> */}
          <Route path="/DashboardUser/:totalOrder_ID/:table_ID/:compoSite" element={<DashboardUser />}></Route>
          <Route path="/DashboardUser/" element={<DashboardUser />}></Route>
          <Route path="/viewMenu/:menu_ID" element={<ViewMenuComponent />}></Route>
          <Route path="/addMenuType" element={<CreateMenuTypeComponent />}></Route>
          <Route path="/addMenu" element={<CreateMenuComponent />}></Route>
          <Route path="/update-Menu/:menu_ID" element={<UpdateMenuComponent />}></Route>
          <Route path="/stockMenu" element={<ListStockMenuComponent />}></Route>
          <Route path="/cart" element={<Cart />}></Route>
          <Route path="/addStockMenu/:menu_ID" element={<CreateStock_MenuComponent />}></Route>
          ...
          <Route path="/CreateTableComponent" element={<CreateTableComponent />}></Route>
          ...
          <Route path="/Checkbill/:compoSite/:discount" element={<Checkbill />}></Route>
          <Route path="/AddRole" element={<AddRoleComponent />}></Route>
          <Route path="/edit-AddRole/:id" element={<AddRoleComponent />}></Route>
          <Route path="/viewEmployee/:id" element={<ViewEmployeeComponent />}></Route>
          <Route path="/promotion" element={<Promotion />}></Route>
          <Route path="/UploadSlip/:totalOrder_ID" element={<Uploadslipcomponent />}></Route>
          {/* <Route path="/ListTotalOrderMenu/:compoSite" element={<ListTotalOrdermenu />}></Route> */}
          <Route path="/ListTotalOrderMenu/:compoSite/:totalOrder_ID" element={<ListTotalOrdermenu />}></Route>
          <Route path="/Kitchen" element={<KitchenComponent />}></Route>
          <Route path="/Movetable/:totalOrder_ID/:table_ID" element={<MoveTable />}></Route>
          <Route path="/MixTable/:table_ID" element={<MixTable />}></Route>
          <Route path="/MixTable/:table_ID/:totalOrder_ID/:compoSite" element={<MixTable />}></Route>
