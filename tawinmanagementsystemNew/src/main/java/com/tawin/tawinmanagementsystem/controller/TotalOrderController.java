...
public class TotalOrderController {
	...
	@GetMapping("/getMixTable/{table_ID}")
	public List<Total_Order> getMixtable(@PathVariable Integer table_ID) {
		return (List<Total_Order>) totalOrderRepo.findByMixTable_ID(table_ID);
	}
	...
	public int Update_Discount(@PathVariable int discount_id, @PathVariable int compo_site) {
		System.out.println(discount_id+" "+compo_site);
